...
def doc():
        ...
        window1.iconbitmap('C:/Users/ABHILASH S/Downloads/medicine.ico.png')
        ...
        def create():
                ...
                def add():
                        ...
                        try:
                                conn= m.connect(host='localhost',user='root', password='ammu69130414')
                                c=conn.cursor()
...
doc=Button(window,text='A Doctor?',command=doc,height=1,bg='grey85',font=('Times',15)).pack(fill=X)
image=ImageTk.PhotoImage(Image.open('C:/Users/ABHILASH S/Downloads/doctorsimage1.jpg'))
label=Label(window,image=image,text=('Welcome to \n'+ name),compound=CENTER,fg='grey1',font=('algerian',80,'italic')).pack()

window.iconbitmap('C:/Users/ABHILASH S/Downloads/medicine.ico.png')
...
def field_but():
        ...
        def clicked():
                ...
                def view(i):
                                ...
                                window2.iconbitmap('C:/Users/ABHILASH S/Downloads/project/medicine.ico')
        ...
        def clicked():
                ...
                for i in d:
                        ...
                        def view(i):
                                ...
                                window2.geometry("500x530")
                                window2.title('HOSPITAL MANAGEMENT SYSTEM')
                                window2.iconbitmap('C:/Users/ABHILASH S/Downloads/medicine.ico.png')
                                label0=Label(window2,text='')
                                label0.grid(row=0,column=0,rowspan=2)
                                label1=Label(window2,text='Name : '+ i[0],font='Times')
                                label1.grid(row=2,column=0,columnspan=2,sticky=W)
...
search_field=Button(window,text='Search by Speciality',height=3,font='calibre',fg='#ffffff',bg='#0d5787',command=field_but).pack(expand=True,fill=X)
search_state=Button(window,text='Search by City/State',height=3,font='calibre',fg='#ffffff',bg='#0d5787',command=state_but).pack(expand=True,fill=X)
